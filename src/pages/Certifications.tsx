...
const Certifications: React.FC = () => {
  ...
  const [allAllcertifications, setCertifications] = useState<Certification[]>([]);
  ...
  if (allAllcertifications.length === 0) return <div>Loading...</div>;

  return (
    <div className="certifications-container">
      <div className="certifications-grid">
        {allAllcertifications.map((cert, index) => (
